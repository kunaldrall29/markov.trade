...
| No keyless WebSocket endpoint proven for `logsSubscribe`; `wss://api.devnet.solana.com` exists but its subscription limits are unmeasured | P09 needs it; strongest argument for the provider key | P09, or the RPC key |
