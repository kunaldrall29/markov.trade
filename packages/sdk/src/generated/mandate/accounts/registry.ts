...
export function getRegistryEncoder(): FixedSizeEncoder<RegistryArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ["globalHalt", getBooleanEncoder()],
      ["adapters", getArrayEncoder(getAddressEncoder(), { size: 8 })],
      ["adaptersLen", getU8Encoder()],
      ["bump", getU8Encoder()],
    ]),
...
export function getRegistryDecoder(): FixedSizeDecoder<Registry> {
  return getStructDecoder([
    ...
    ["globalHalt", getBooleanDecoder()],
    ["adapters", getArrayDecoder(getAddressDecoder(), { size: 8 })],
    ["adaptersLen", getU8Decoder()],
    ["bump", getU8Decoder()],
  ]);
}
