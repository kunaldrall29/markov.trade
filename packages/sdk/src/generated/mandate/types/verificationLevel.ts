...
export function getVerificationLevelCodec(): Codec<VerificationLevelArgs, VerificationLevel> {
  return combineCodec(getVerificationLevelEncoder(), getVerificationLevelDecoder());
}

// Data Enum Helpers.
export function verificationLevel(
  kind: "Partial",
  data: GetDiscriminatedUnionVariantContent<VerificationLevelArgs, "__kind", "Partial">,
...
export function verificationLevel<K extends VerificationLevelArgs["__kind"], Data>(
  kind: K,
  data?: Data,
) {
