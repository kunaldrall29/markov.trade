...
export function getPriceFeedMessageCodec(): FixedSizeCodec<PriceFeedMessageArgs, PriceFeedMessage> {
  return combineCodec(getPriceFeedMessageEncoder(), getPriceFeedMessageDecoder());
}
