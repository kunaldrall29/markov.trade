...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      ...
      { rel: "preload", href: "/fonts/Outfit-600-latin.woff2", as: "font", type: "font/woff2", crossOrigin: "anonymous" },
      { rel: "preload", href: "/fonts/JetBrainsMono-400-latin.woff2", as: "font", type: "font/woff2", crossOrigin: "anonymous" },
